#!/bin/bash
#SBATCH --job-name=Temp_PGW_COSMO_preprocessing
...
T2M_DIR="/reference/FGSE/climate_simulations/cosmo6_2km_climate_PGW_MPI_HR/1h_2D/"
TMP_dir=$(mktemp -d "$BASE_DIR/sasthana/Downscaling/COSMO_RGG/COSMO/COSMO_pgw/tmp_temp_XXXXXX")
...
cdo mergetime "$TMP_dir"/*.nc "$BASE_DIR/sasthana/Downscaling/COSMO_RGG/COSMO/COSMO_pgw/COSMO_t2m_pgw.nc"
rm -r "$TMP_dir"
